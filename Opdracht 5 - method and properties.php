...
class Milkshake{
//Implement the milkshake class. It should have a constructor that takes a flavor and a content as arguments.
}
...
function checkConstructor($chocolate, $strawberry){
    ...
    if (!method_exists($chocolate, "__construct")){
        echo "Mistake: Milkshake does not have a constructor<br>";
        $AllGood = False;
    }
